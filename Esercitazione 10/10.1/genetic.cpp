...
/////////////////////METHODS IMPLEMENTED FOR THE SIMULATED ANNEALING////////////////
...
void Species :: Annealing(){ //Changes the temperature by the chosen coefficient
  m_temp *= m_ann_coeff;
}
void Species :: Accept(){
  if(m_rnd->Rannyu()<this->GetAlpha()){ //Probability dictated by the length
    m_pop[0]=m_pop[1];
  }else{
    m_pop[1]=m_pop[0];
  }
...
void Species :: Rearrange(){ //Performs a swap  and an inversion between cities
